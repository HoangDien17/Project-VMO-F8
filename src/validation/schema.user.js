...
const createInforSchema = Joi.object({
  ...
  phone: Joi.string().required().pattern(new RegExp("^(0)[0-9]{9,10}$")),
...
const updateInforSchema = Joi.object({
  ...
  firstName: Joi.string().optional().alphanum(),
  lastName: Joi.string().optional().alphanum(),
